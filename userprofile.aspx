                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <center>
                                ...
                                <asp:Label class="badge text-bg-info" runat="server" Text="Your Status"></asp:Label>
                            </center>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label>User Id</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="User Id" Enabled="False"></asp:TextBox>
                                <br />
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Old Password" TextMode="Password" Enabled="False"></asp:TextBox>
                                <br />
                            </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="row">
                        <div class="col">
                            <center>                                
                                <img src="images/alotsbooks.png" style="width: 150px;" />
                            </center>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <center>
                                ...
                                <asp:Label class="badge text-bg-info" runat="server" Text="Your Book Info"></asp:Label>
                            </center>
                        </div>
                    </div>
                    <div class="row">
